...
survey_df.drop(columns=['dream', 'pmEmotion', 'pmStress', 'pmFatigue'], inplace=True)

survey_df[['sleep', 'sleepProblem', 'amCondition', 'amEmotion']] = survey_df[['sleep', 'sleepProblem', 'amCondition', 'amEmotion']].fillna(0)
...
# 2행씩 짝지어 더하기
new_columns = ['sleep', 'sleepProblem', 'amCondition', 'amEmotion']
...
survey_reason.to_csv(r"D:\dataset\created_data\Q2_survey_reason.csv", index=False)
